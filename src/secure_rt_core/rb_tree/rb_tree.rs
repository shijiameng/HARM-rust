...
impl RBTree {
    ...
    fn compare(node: Rc<RefCell<RBNode>>, target: u32) -> i8 {
    ...
    fn node_search(&self, key: u32) -> (i8, Option<Rc<RefCell<RBNode>>>) {
    ...
    pub fn get_node(&self, key: u32) -> Option<RBNode> {
    ...
    pub fn put(&mut self, key: u32, data: String) {
    ...
    pub fn put_node(&mut self, key: u32, mut this: RBNode) {
        this.parent = None;
        this.key = key;
